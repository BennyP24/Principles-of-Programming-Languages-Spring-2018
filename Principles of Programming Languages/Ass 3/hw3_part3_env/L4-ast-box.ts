...
import { AtomicExp, VarDecl,LazyVarDecl, VarRef } from './L3-ast';
import { isAtomicExp } from './L3-ast';
import { isArray, isEmpty, isNumericString, isSexpString, isString } from './L3-ast';
import { makeVarDecl,makeLazyVarDecl, makeVarRef, makeVar } from './L3-ast';
...
export interface Binding4 {tag: "Binding4"; var: (VarDecl | LazyVarDecl); val: CExp4; };
// L3
...
export const makeBinding4 = (v: (VarDecl | LazyVarDecl), val: CExp4): Binding4 =>
...
const parseProcExp4 = (sexps: any[]): ProcExp4 | Error =>
    safeFL((body: CExp4[]) => makeProcExp4( map(makeVar, sexps[1]), body))
...
const safeMakeBindings4 = (decls: (VarDecl | LazyVarDecl)[] | Error, vals: Array<CExp4 | Error>): Binding4[] | Error =>
    isError(decls) ? decls :
